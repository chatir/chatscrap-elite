...
with tab_live:
    ...
    if st.session_state.results_list:
        ...
        # 🔥 MODIFIED TO HTML FOR ICON SUPPORT
                    ...
                    if not st.session_state.paused and st.session_state.running:
                        ...
                        for item in items:
                            ...
                            try:
                                ...
                                processed += 1
                            # 🔥 Exception Fix to handle Rerun gracefully
...
st.markdown('<div style="text-align:center;color:#666;padding:30px;">Designed by Chatir Elite Pro - Architect Edition V59</div>', unsafe_allow_html=True)
