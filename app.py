...
# ==============================================================================
# 2. DESIGN SYSTEM (STRICT ORANGE SUPREME)
# ==============================================================================
...
def init_db():
    with sqlite3.connect(DB_NAME, check_same_thread=False) as conn:
        ...
        cursor.execute("""CREATE TABLE IF NOT EXISTS leads (
            ...
            website TEXT, email TEXT, whatsapp TEXT)""")
...
# ==============================================================================
# 5. SIDEBAR & ADMIN PANEL (FULLY ACTIVATED)
# ==============================================================================
with st.sidebar:
...
# ==============================================================================
# 8. ENGINE & EMAIL EXTRACTION LOGIC
# ==============================================================================
def get_driver():
    opts = Options()
                ...
                for kw in kws:
                    ...
                    for item in items:
                        ...
                        try:
                            ...
                            if w_web and (raw_web == "N/A" or not raw_web): continue
                            if w_nosite and raw_web != "N/A": continue

                            # Display Logic (Only show web if checkbox is checked)
                            ...
                            # 🔥 Deep Email Extraction (Activated)
                            email = fetch_email(driver, raw_web) if w_email else "N/A"

                            row = {"Keyword":kw, "City":city, "Name":name, "Phone":phone, "WhatsApp":wa_link, "Website":display_web, "Email":email}
                            
                            with sqlite3.connect(DB_NAME) as conn:
                                conn.execute("""INSERT INTO leads (session_id, keyword, city, country, name, phone, website, email, whatsapp)
                                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)""", (st.session_state.current_sid, kw, city, country_in, name, phone, display_web, email, wa_link))
...
st.markdown('<div style="text-align:center;color:#666;padding:30px;">Designed by Chatir Elite Pro - Architect Supreme V34</div>', unsafe_allow_html=True)
