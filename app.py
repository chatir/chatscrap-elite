...
# ==============================================================================
# 1. SYSTEM CONFIGURATION & STATE (THE BRAIN)
# ==============================================================================
...
st.markdown(f"""
    ...
    /* Progress Bar Animation (RESTORED) */
            ...
            try:
                for city in ct_list:
                    for kw in kw_list:
                        ...
                        driver.get(url); time.sleep(4) # Increased wait time for Google Maps

                        # 🔥 FIX 0% STUCK (ROBUST SCROLL)
                        try:
