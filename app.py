...
# ==============================================================================
# 8. ENGINE & ANTI-FREEZE SELENIUM LOGIC (V89)
# ==============================================================================
def get_driver():
                ...
                for i, (city, kw) in enumerate(all_tasks):
                    ...
                    for item in items:
                        ...
                        try:
                            ...
                            # 🔥 ROOT FIX: ROBUST RATING & REVIEWS EXTRACTION
...
st.markdown('<div style="text-align:center;color:#666;padding:30px;">Designed by Chatir Elite Pro - Architect Edition V89</div>', unsafe_allow_html=True) #
