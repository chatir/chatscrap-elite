...
# ==============================================================================
# 2. DESIGN SYSTEM (FIXED 70/30 & COLORS)
# ==============================================================================
...
st.markdown(f"""
    ...
    /* STOP BUTTON (Right 30%) - DARK REDISH */
...
# ==============================================================================
# 5. SIDEBAR & ADMIN PANEL (NOW FULLY FUNCTIONAL)
# ==============================================================================
with st.sidebar:
                    ...
                    for item in items:
                        ...
                        try:
                            ...
                            with sqlite3.connect(DB_NAME) as conn:
                                ...
                                conn.commit() # Ensuring credit deduction is saved
...
st.markdown('<div style=\"text-align:center;color:#666;padding:30px;\">Designed by Chatir Elite Pro - Rebuilt Base V1</div>', unsafe_allow_html=True)
