...
st.markdown(f"""
    ...
    .stButton > button {{
        width: 100% !important; /* This fills the 70% or 30% space completely */
        ...
        justify-content: center !important; /* Centering text horizontally */
        align-items: center !important;     /* Centering text vertically */
        text-align: center !important;
    }}
    
    /* START BUTTON (Left 70%) */
...
# ==============================================================================
with st.container():
    c1, c2, c3, c4 = st.columns([3, 3, 2, 1.5]) # Natural spacing here
    ...
    btn_col1, btn_col2 = st.columns([7, 3]) # Start 70% | Stop 30%
    with btn_col1:
...
with tab_archive:
    ...
    search_f = st.text_input("Filter Archives", placeholder="🔍 Search e.g. 'lawyer' or 't Tanger'...")
...
st.markdown('<div style="text-align:center;color:#666;padding:30px;">Designed by Chatir Elite Pro - Architect Supreme V28</div>', unsafe_allow_html=True)
